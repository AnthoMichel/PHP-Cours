...
<body>
    ...
    <main class="container">
        ...
        <form class="bg-light shadow p-3 form-group col-6 m-auto border" action="createValid.php" method="post">
            <input type="text" class="form-control my-2" name="nom" placeholder="nom du jeu">
            <input type="text" class="form-control my-2" name="possesseur" placeholder="proprio">
            <input type="text" class="form-control my-2" name="console" placeholder="plateforme">
